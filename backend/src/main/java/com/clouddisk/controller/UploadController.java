...
public class UploadController {
    ...
    @PostMapping("/merge")
    @SentinelResource(value = "upload_api", blockHandler = "uploadBlocked")
    public FileVO merge(@RequestBody Map<String, String> body) throws Exception {
        return VOMapper.toFileVO(uploadService.merge(body.get("uploadId"), body.get("mimeType")));
    }
